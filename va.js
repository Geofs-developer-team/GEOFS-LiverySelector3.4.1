function init(){
    ...
    links.forEach(async function(e){
        await fetch("https://raw.githubusercontent.com/Geofs-developer-team/GEOFS-LiverySelector3.4.1/refs/heads/main/livery.json").then(res => res.json()).then(data => valiveryobj[e] = data)
    });
}
