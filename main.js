const githubRepo = 'https://raw.githubusercontent.com/Geofs-developer-team/GEOFS-LiverySelector3.4.1/main';
let jsDelivr = 'https://cdn.jsdelivr.net/gh/Geofs-developer-team/GEOFS-LiverySelector3.4.1@main';
...
(async function init() {
    ...
    try {
        const res = await fetch(`https://api.github.com/repos/Geofs-developer-team/GEOFS-LiverySelector3.4.1/commits/main`);
...
function generateListHTML() {
    return `
        ...
        <br/>
        <a href="https://github.com/Geofs-developer-team/GEOFS-LiverySelector3.4.1/tree/main/tutorial" target="_blank"><button class="mdl-button mdl-js-button mdl-button--raised mdl-button">Open Tutorial</button></a><br/>
        ...
        <a href="https://github.com/Geofs-developer-team/GEOFS-LiverySelector3.4.1" target="_blank"><button class="mdl-button mdl-js-button mdl-button--raised mdl-button">Visit our Github page</button></a><br/>
